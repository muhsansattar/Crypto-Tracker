...
Welcome to the Crypto Tracker application! This web application allows users to track cryptocurrency prices and market data in real time.
...
- User-friendly interface for viewing and managing favorite cryptocurrencies.
...
- **Moralis**: A platform for user authentication and managing user sessions and data storage.
- **Coingecko API**: Provides real-time cryptocurrency market data, including prices, volume, and market capitalization.
